    ...
    return (
        <header className="body-font text-white bg-sky-800 shadow-lg fixed z-10 w-full">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                {user?.uid ?
                    <>
                        <Link to="/myItems" className="mr-5 hover:text-gray-300 font-medium uppercase">My Items</Link>
                        <Link to="/addItems" className="mr-5 hover:text-gray-300 font-medium uppercase">Add Items</Link>
                        <Link to="/manageItems" className="mr-5 hover:text-gray-300 font-medium uppercase">Manage Items</Link>
