...
const InventoryItem = ({ inventoryItem}) => {
    const {_id, name, img, price, stock, description, supplier } = inventoryItem;
            ...
            <div className="h-full border-2 bg-gray-50 border-gray-200 border-opacity-60 rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center mt-2.5 mb-5">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <button onClick={() => navigateToDetails(_id)} className="text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm  px-5 py-2.5 text-center bg-sky-800">UPDATE</button>
