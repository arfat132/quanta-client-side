...
const AddItems = () => {
    ...
    const handleAddItems = (event) => {
        ...
        const addInventory = { email, name, image, price, description, supplier, stock };
    ...
    return (
        ...
        <div className='py-24 w-6/12 mx-auto'>
            ...
            <form onSubmit={handleAddItems} className='bg-gray-50 p-8 border border-blue-200 rounded-lg mt-12 shadow-lg'>
                ...
                <div className="relative z-0 w-full mb-6 group">
                    <input type='text' alt=" " name="image" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-sky-800 peer" placeholder=" " required="" />
