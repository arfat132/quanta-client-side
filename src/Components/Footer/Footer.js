...
const Footer = () => {
  return (
    <footer className="bg-gray-700 bottom-0 text-gray-400">
      <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
          <Link to="" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
            <img src="" alt="" />
            <span className="relative text-2xl font-semibold text-sky-800">QUANTA</span>
          </Link>
        ...
        <p class="flex items-center justify-center md:justify-start mb-2">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="home"
            class="w-4 mr-4 text-teal-500" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
        ...
        <p class="flex items-center justify-center md:justify-start mb-2">
          <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="envelope"
            class="w-4 mr-4 text-teal-500" role="img" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512">
            <path fill="currentColor"
      ...
      <div className="bg-gray-700">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">© 2022 Core Realtor —
            <Link to="" href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-400 ml-1" target="_blank">@core-realtor</Link>
          </p>
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
            ...
            <Link to="" className="ml-3 text-teal-500">
              <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-5 h-5" viewBox="0 0 24 24">
