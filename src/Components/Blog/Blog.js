...
const Blog = ({ blog }) => {
  const { question, answer, img, comments, viewrs, category } = blog;
  return (
        ...
        <div className="p-6">
          ...
          <div className="flex items-center flex-wrap ">
            <Link to='' className="text-white px-4 py-2 bg-blue-900 rounded-tr-3xl rounded-bl-3xl  font-extrabold inline-flex items-center md:mb-2 lg:mb-0">Learn More
              <svg className="w-4 h-4 ml-2" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" stroke-Linejoin="round">
